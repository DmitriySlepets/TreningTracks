...
<header>
    ...
    <div class = "header-middle">
        <div class="caption">Тренинг-трек позволит тебе</br>быстро освоить профессию</br>
            в сфере управления проектами</div>
    </div>
    <div class="header-bottom">
        <div class="title-icons">Выберите свой трек</div>
        <div class="icons"><img src="/img/type-curses/icon1.png" /></div>
    </div>
...
<div id="main">
    <div class="menu">
        <ul>
            <li><a href="#">Участникам</br>проектных команд</a></li>
            <li><a href="#">Опытным</br>руководителям</a></li>
            <li><a href="#">Отраслевые</br>треки</a></li>
            <li class="active"><a href="#">Project management</br>для всех</a></li>
        </ul>
    </div>
    <div class="content ver4">
        ...
        <div class="arrows">
            <div class="left-arrow"><a href="#"><img src="/img/type-curses/left.png" /></a></div>
            <div class="right-arrow"><a href="#"><img src="/img/type-curses/right.png" /></a></div>
        </div>
